...
type PersonFormProps = {
  ...
  initialData?: Partial<PersonSchema>;
};

export const PersonForm: React.FC<PersonFormProps> = ({ onSubmit, initialData }) => {
  const { control, handleSubmit, watch, formState: { errors } } = useForm<PersonSchema>({
  ...
  useEffect(() => {
    if (!family || family.length === 0) {
      appendFamilyMember({ name: '', lastName: '', ci: '' });
    }
  }, [family, appendFamilyMember]);

  const onSubmitWrapper = async (data: PersonSchema) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}  className="space-y-4">
      ...
      {/*      <Input {...field} id="ci" placeholder="CI"/>*/}
      ...
      {/*  render={({field}) => (*/}
      {/*    <div className="flex items-center space-x-2">*/}
      {/*      <Checkbox id="hasFarm" checked={field.value} onCheckedChange={field.onChange}/>*/}
      ...
      {/*          {errors.totalWorkers && <p className="text-red-500">{errors.totalWorkers.message as React.ReactNode}</p>}*/}
      {/*        </div>*/}
      {/*      )}*/}
      {/*    />*/}
      ...
      {/*          {errors.womanWorkers && <p className="text-red-500">{errors.womanWorkers.message as React.ReactNode}</p>}*/}
      {/*        </div>*/}
      {/*      )}*/}
      {/*    />*/}
      ...
      {/*          {errors.over18Workers && <p className="text-red-500">{errors.over18Workers.message as React.ReactNode}</p>}*/}
      {/*        </div>*/}
      {/*      )}*/}
      {/*    />*/}
      ...
      {/*          {errors.under18Workers && <p className="text-red-500">{errors.under18Workers.message as React.ReactNode}</p>}*/}
      {/*        </div>*/}
      {/*      )}*/}
      {/*    />*/}
